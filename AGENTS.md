...
expanded quality dimension, graph-backed whole-codebase impact surface,
...
`BMAD_REVIEW_IMPACT_CONTEXT=path/to/context.md`, or let the wrapper generate a
bounded local graph/relationship context.
