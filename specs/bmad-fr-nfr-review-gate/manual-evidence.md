...
| Markdown NFR scorecard rows     | Run Bats fake-agent tests for markdown NFR scorecard table rows.                                                       | GFM table rows, with optional outer pipes and escaped pipe cells, require score-cell 5/5. | FR-06, FR-07, AC-05  |
