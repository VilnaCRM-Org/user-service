...
[issue form](https://github.com/VilnaCRM-Org/php-service-template/issues/new).

#### Solve an issue

Scan through our
[existing issues](https://github.com/VilnaCRM-Org/php-service-template/issues)
...
2. Install or update to **Docker** and **Docker compose**. For more information,
...
- Enable the checkbox to
  ...
  so the branch can be updated for a merge. Once you submit your PR, our team
