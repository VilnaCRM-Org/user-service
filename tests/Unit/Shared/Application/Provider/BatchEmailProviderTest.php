...
final class BatchEmailProviderTest extends UnitTestCase
{
    private BatchEmailProvider $batchEmailProvider;

    #[\Override]
    protected function setUp(): void
    {
        parent::setUp();
        $this->batchEmailProvider = new BatchEmailProvider(new BatchEmailResolver());
    }
    ...
    public function testCollectsEmailsAndDetectsMissing(): void
    {
        ...
        $collection = $this->batchEmailProvider->collect($entries);
    ...
    {
        $reflection = new ReflectionClass($this->batchEmailProvider);
        $method = $reflection->getMethod('toArray');
        $this->makeAccessible($method);

        $result = $method->invoke($this->batchEmailProvider, $entries);
