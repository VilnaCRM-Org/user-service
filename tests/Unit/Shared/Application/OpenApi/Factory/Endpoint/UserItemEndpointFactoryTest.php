...
use App\Shared\Application\OpenApi\Factory\Endpoint\UserItemEndpointFactory;
...
use App\Shared\Application\Provider\OpenApi\UserItemResponseProvider;
use App\Tests\Unit\UnitTestCase;

final class UserItemEndpointFactoryTest extends UnitTestCase
{
    ...
    public function testCreateEndpoint(): void
    {
        ...
        $factory = $this->createUserItemEndpointFactory();
    ...
    private function initializeMocks(): void
    {
        ...
        $this->userTimedOutResponseFactory = $this->createMock(UserTimedOutResponseFactory::class);
    ...
    private function createUserItemEndpointFactory(): UserItemEndpointFactory
    {
        $responseProvider = new UserItemResponseProvider(
        ...
        return new UserItemEndpointFactory(
            getenv('API_PREFIX'),
            $responseProvider,
    ...
    private function setResponseFactoryExpectations(): void
    {
        ...
        $this->userDeletedResponseFactory->expects($this->once())
            ->method('getResponse')->willReturn($this->createMock(Response::class));
        $this->userTimedOutResponseFactory->expects($this->once())
            ->method('getResponse')->willReturn($this->createMock(Response::class));
