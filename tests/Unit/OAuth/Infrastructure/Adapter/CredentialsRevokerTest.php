...
namespace App\Tests\Unit\OAuth\Infrastructure\Adapter;

use App\OAuth\Infrastructure\Adapter\CredentialsRevoker;
...
final class CredentialsRevokerTest extends OAuthInfrastructureTestCase
{
    ...
    /**
     * @return array{
     *     accessUpdate: list<string>,
     *     authUpdate: list<string>,
     *     accessSelect: list<string>,
     *     refreshUpdate: list<string>
     * }
     */
