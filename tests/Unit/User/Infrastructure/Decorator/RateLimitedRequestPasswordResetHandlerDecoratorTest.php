...
final class RateLimitedRequestPasswordResetHandlerDecoratorTest extends UnitTestCase
{
    ...
    private RateLimitedRequestPasswordResetHandlerDecorator $decorator;
    ...
    protected function setUp(): void
    {
        ...
        $this->decorator = new RateLimitedRequestPasswordResetHandlerDecorator(
            $this->innerHandler,
    ...
    public function testNormalizesEmailBeforeUsingItAsLimiterKey(): void
    {
        ...
        $this->expectLimiterKey('user@example.com', accepted: true);
    ...
    {
        $this->expectLimiterKey(strtolower(trim($email)), $accepted);
    }

    private function expectLimiterKey(string $limiterKey, bool $accepted): void
    {
        $this->rateLimiterFactory
            ->expects($this->once())
            ->method('create')
