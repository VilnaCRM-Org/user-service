...
final class PasskeyJsonCodecTest extends UnitTestCase
{
    ...
    public function testOptionsToArrayUsesInjectedSerializerAndAssociativeJsonDecoder(): void
    {
        ...
        self::assertSame(
            $payload,
            (new PasskeyJsonCodec($factory, $serializer, $jsonEncoder))->optionsToArray($options)
        );
    }
    ...
    private function createUnexpectedTypeCodec(): PasskeyJsonCodec
    {
        $serializer = $this->createMock(SerializerInterface::class);
    ...
    private function createCodec(): PasskeyJsonCodec
    {
        return new PasskeyJsonCodec(new PasskeyWebauthnFactory($this->createConfiguration()));
    }

    private function createCodecWithSerializer(SerializerInterface $serializer): PasskeyJsonCodec
    {
        return new PasskeyJsonCodec(
