...
final class UsersUpdatedMetricFactoryTest extends UnitTestCase
{
    public function testCreateWithDefaultValue(): void
    {
        $factory = new UsersUpdatedMetricFactory();

        $metric = $factory->create();

        self::assertInstanceOf(UsersUpdatedMetric::class, $metric);
