...
final class AuthCookieFactoryTest extends UnitTestCase
{
    ...
    {
        $cookie = $this->factory->create($this->faker->sha256(), false, 900, 2592000);
    ...
    public function testCreateReturnsCookieWithCorrectToken(): void
    {
        ...
        $cookie = $this->factory->create($token, false, 900, 2592000);
    ...
    {
        $cookie = $this->factory->create($this->faker->sha256(), true, 900, 2592000);
