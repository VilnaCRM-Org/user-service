...
final class PasswordValidatorIntegrationTest extends IntegrationTestCase
{
    ...
    public function testPasswordTooShort(): void
    {
        ...
        $this->assertEquals('password.invalid.length', $violations[0]->getMessage());
    }
    ...
    public function testPasswordWithoutNumber(): void
    {
        ...
        $this->assertCount(1, $violations);
        $this->assertEquals('password.missing.number', $violations[0]->getMessage());
    }
    ...
    public function testPasswordWithoutUppercase(): void
    {
        ...
        $this->assertCount(1, $violations);
        $this->assertEquals('password.missing.uppercase', $violations[0]->getMessage());
    }
}